...
//Dynamic typing
console.log(name + ","+ age); //string and number 
console.log(age + age); //The output is a number 

var job, isMarried; //Type is not defined upfront 

console.log(job); //This prints 'undefined' because the value is not assigned to this variable 
...
ageJohn = 3 +  5 * 4 -6; //order: multiplication addition and subtraction
ageJohn = ageMark = (3 + 5) * 4 - 6; //() gets first precedence

//Associativity goes from right to left 
//ageJohn = ageMark = 26 //STARting from right and hence 26 instead of 30 
//ageJohn = 26
...
//console.log(john);
john.pop(); //pops the last element 'blue'
john.pop(); //pops the last element 'false'
console.log(john);
john.shift(); //removes the first element 'Mr'
console.log(john);
